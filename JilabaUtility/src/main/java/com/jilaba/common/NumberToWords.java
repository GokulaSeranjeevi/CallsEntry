 ...
 */
 public final class NumberToWords {
        ...
        public static String convertNumberToWords(BigDecimal parameter1) {

        	BigDecimal localParam = parameter1;
        	
            boolean negativeAmount = false;
            
            if (localParam.signum() == -1) {
                negativeAmount = true;
                localParam = localParam.abs();
            }
            
            StringBuilder word = new StringBuilder();
            
            String numberString = localParam.setScale(2,
